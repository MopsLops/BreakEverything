...
execute if score .distance dist matches ..200 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ #scr:raycast_pass2 run function scr:raycast_set_moon/raycast
...
execute if score .distance dist matches ..200 positioned ^ ^ ^3 rotated ~ ~ if block ~ ~ ~ air run function scr:raycast_set_moon/moon